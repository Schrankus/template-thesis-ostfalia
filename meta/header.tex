...
% set fonts of titles
\titleformat{\chapter}[display] {\normalfont \huge \bfseries}{}{0pt}{\Huge \ifnum\value{chapter}>0 \thechapter\ \fi}
\titlespacing*{\chapter}{0pt}{0pt}{0pt}
\titleformat{\section}[display] {\normalfont \Large \bfseries}{}{0pt}{\LARGE \thesection\ }
\titlespacing*{\section}{0pt}{0pt}{0pt}
\titleformat{\subsection}[display] {\normalfont \large \bfseries}{}{-15pt}{\Large \thesubsection\ }
\titlespacing*{\subsection}{0pt}{0pt}{0pt}
\titleformat{\subsubsection}[display] {\normalfont \normalsize \bfseries}{}{-15pt}{\large \thesubsubsection\ }
